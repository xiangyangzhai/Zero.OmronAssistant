...
namespace S7.Net
{
    ...
    internal class COTP
    {
        ...
        public class TPDU
        {
            ...
            public  static TPDU ReadSync(Stream stream)
            {
                var tpkt =  TPKT.ReadSync(stream);
                if (tpkt.Length == 0)
                {
        ...
        public class TSDU
        {
            ...
            public static  byte[] ReadSync(Stream stream)
            {
                var segment =  TPDU.ReadSync(stream);
